...
export const ACTIVE: LegislationRow[] = [
  ...
  },
  {
    ...
    cannotMeasure: "HB5284 names women experiencing menopause as the population the law was written to protect. The Illinois Human Rights Act amendment activates on an employee request for accommodation. Insurance coverage activates January 1, 2028, and only when treatment is sought under a clinical record. Provider education resources are entirely voluntary. The women performing through symptoms without requesting accommodation and without a clinical record are named in the legislative findings and excluded by every activation condition the bill creates.",
    classification: "Tacere",
    notes: "Omnibus structure combines public education, insurance coverage (effective 2028), and workplace accommodation under the IHRA. The accommodation provision explicitly lists cognitive and mood changes as covered conditions. This is the most analytically significant inclusion in the bill. Coverage for cognitive symptoms is named. Whether an employee requests accommodation for them is a separate question the bill cannot answer.",
