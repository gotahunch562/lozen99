...
export const ACTIVE: LegislationRow[] = [
  ...
  },
  {
    ...
    cannotMeasure: "HB5284 names menopause and perimenopause as conditions requiring public education, insurance coverage, and workplace notice recognition. The final version does not create a standalone menopause discrimination claim or a standalone menopause accommodation right. Coverage activates only when treatment is recommended by a qualified health care provider and prescribed under evidence-based guidelines. Workplace recognition is routed through pregnancy-accommodation notice language. Women managing symptoms without clinical engagement, without a request, or without a usable workplace disclosure pathway remain outside the record the bill can generate.",
    classification: "Tacere",
