...
const trackerRows = [
  {
    ...
    impactArea:
      "To improve the functioning of the internal market, promote a human-centric and trustworthy AI approach, ensure a high-level of protection against harmful effects of AI systems, and support innovation",
  ...
  },
  {
    ...
    sectorScope: "Private",
    impactArea:
      "To regulate automated decision-making technology (ADMT) that materially influences consequential decisions",
    ...
    updateNote:
      "Legislative update: June 2026. Colorado repealed and replaced the prior Colorado AI Act / CAIA before it took effect.",
  },
  {
    ...
    sectorScope: "Public",
    impactArea:
      "To ensure that departments are transparent, accountable and fair in automated decision-making",
  ...
  },
  {
    ...
    sectorScope: "Dual / Shared Sector Scope",
    impactArea:
      "To encourage voluntary and proactive efforts by all AI-related actors for the appropriate conduct of AI research, development, and utilization",
  ...
  },
  {
    ...
    sectorScope: "Public",
    impactArea:
      "promotes a human-centric approach to trustworthy AI, fosters research, and preserves economic incentives to innovate",
    nameStandardSignal: "Human oversight mentioned but undefined",
  ...
  },
  {
    ...
    sectorScope: "Private",
    impactArea:
      "To establish and maintain a reasonable internal process through which a covered employee... may anonymously submit a report... of a specific and substantial danger to the public health or safety",
    nameStandardSignal: "Documentation / record retention only",
    liveDate: "Jan 1, 2026",
    sourceUrl:
  ...
  },
  {
    ...
    sectorScope: "Private",
    impactArea:
      "To prohibit an employer from using artificial intelligence in a manner that has the effect of subjecting employees to unlawful discrimination... without prior notice",
    nameStandardSignal: "Documentation / record retention only",
    liveDate: "Jan 1, 2026",
  ...
  },
  {
    ...
    sectorScope: "Private",
    impactArea:
      "Prohibits health insurers from using solely automated AI algorithms to downcode or deny reimbursement claims without clinical justification and manual medical record review",
  ...
  },
  {
    ...
    sectorScope: "Private",
    impactArea:
      "prohibiting a food retailer and a third–party food delivery service provider from engaging in the practice of dynamic pricing or using consumer surveillance personal data to set a price",
  ...
  },
  {
    ...
    sectorScope: "Private",
    impactArea:
      "To make rules about access and opt-out rights relating to businesses’ use of automated decisionmaking technology (ADMT)",
    nameStandardSignal: "Explicit human review required",
  ...
  },
  {
    ...
    sectorScope: "Dual / Shared Sector Scope",
    impactArea:
      "To create the Office of Artificial Intelligence Policy... and to provide requirements for generative artificial intelligence",
    nameStandardSignal: "Documentation / record retention only",
    liveDate: "May 1, 2024",
  ...
  },
  {
    ...
    sectorScope: "Dual / Shared Sector Scope",
    impactArea:
      "prohibits the development or deployment of AI systems for restricted purposes while offering affirmative defenses for NIST AI Risk Management Framework compliance",
    nameStandardSignal: "Documentation / record retention only",
    liveDate: "Jan 1, 2026",
  ...
  },
  {
    ...
    sectorScope: "Dual / Shared Sector Scope",
    impactArea:
      "Outlines voluntary guardrails for organizations across the AI supply chain to manage risks, protect data, and ensure human oversight",
    nameStandardSignal: "Human oversight mentioned but undefined",
    liveDate: "Sep 2024",
  ...
  },
  {
    ...
    sectorScope: "Private",
    impactArea:
      "establishing a reasonable internal process through which (A) a covered employee of such large frontier developer may anonymously submit a report... of catastrophic risk",
  ...
  },
  {
    ...
    sectorScope: "Dual / Shared Sector Scope",
    impactArea:
      "prohibiting the nonconsensual online distribution of intimate deepfakes and requiring covered platforms to establish a 48-hour removal mechanism",
    nameStandardSignal: "Documentation / record retention only",
  ...
  },
  {
    ...
    sectorScope: "Private",
    impactArea:
      "systems shall not issue an adverse determination to a patient until a natural person... conducts a utilization review in which a clinical peer participates",
    nameStandardSignal: "Explicit human review required",
    liveDate: "Jan 1, 2027",
  ...
  },
  {
    ...
    sectorScope: "Private",
    impactArea:
      "To establish a safety framework for large frontier AI developers... addressing catastrophic risks, governance, and cybersecurity",
    nameStandardSignal: "Documentation / record retention only",
    liveDate: "Jan 1, 2027",
  ...
  },
  {
    ...
    sectorScope: "Private",
    impactArea:
      "mandating that developers of generative AI systems publish a high-level summary of the training datasets",
    nameStandardSignal: "Documentation / record retention only",
    liveDate: "Jan 1, 2026",
    sourceUrl:
  ...
  },
  {
    ...
    sectorScope: "Private",
    impactArea:
      "expanding the state's right of publicity law to protect individuals' voices against unauthorized AI-generated replicas",
    nameStandardSignal: "No human accountability mechanism found",
  ...
  },
  {
    ...
    sectorScope: "Private",
    impactArea:
      "creating digital-likeness rights to prevent unauthorized AI voice and likeness reproduction",
    nameStandardSignal: "No human accountability mechanism found",
  ...
  },
  {
    ...
    sectorScope: "Dual / Shared Sector Scope",
    impactArea:
      "prohibiting creating or distributing fraudulent deepfakes of political candidates within 90 days of an election unless AI use is clearly disclosed",
    nameStandardSignal: "No human accountability mechanism found",
  ...
  },
  {
    ...
    sectorScope: "Dual / Shared Sector Scope",
    impactArea:
      "prohibiting the distribution of materially deceptive AI-generated media depicting political candidates intended to influence an election without disclosure",
    nameStandardSignal: "No human accountability mechanism found",
    liveDate: "Oct 1, 2024",
  ...
  },
  {
    ...
    sectorScope: "Private",
    impactArea:
      "prohibiting AI technology providers from falsely claiming healthcare licenses and mandating disclosures when AI tools generate clinical communications",
    nameStandardSignal: "Documentation / record retention only",
    liveDate: "Jan 1, 2026",
    sourceUrl:
  ...
  },
  {
    ...
    sectorScope: "Private",
    impactArea:
      "requiring chatbot operators to notify users of AI interaction, implement protections for minors, and follow crisis response protocols",
    nameStandardSignal: "Documentation / record retention only",
  ...
  },
  {
    ...
    sectorScope: "Private",
    impactArea:
      "Requires large frontier AI developers to publish safety plans, report critical incidents within 72 hours, and refrain from releasing models that fail testing.",
    nameStandardSignal: "Documentation / record retention only",
    liveDate: "Jan 1, 2027",
  ...
  },
  {
    ...
    sectorScope: "Public",
    impactArea:
      "Requires public entities in Arkansas to develop comprehensive policies regarding the authorized use of AI and automated decision-making technology.",
  ...
  },
  {
    ...
    sectorScope: "Private",
    impactArea:
      "Requires employers using AI to analyze job applicant video interviews to provide notice, obtain consent, and follow data destruction timelines.",
    nameStandardSignal: "Not applicable",
    liveDate: "Jan 1, 2020",
