...
heroImage: /src/images/blog/decision-debt-lozen-advisory-1.avif
...
Decision debt is the liability created when automated or AI-assisted decisions cannot be reliably reconstructed, explained, verified, or assigned to an accountable human. It builds when an enterprise relies on AI-generated decisions without capturing the rules, the system version, the data available, the human review path, the exception rationale, or the responsible business owner. It is not a future failure; it is the present mismatch between [AI execution speed and institutional proof.](/blog/mandatory-ai-use-governance/)
