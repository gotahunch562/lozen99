...
Workforce studies draw from formal system records: accommodations, leave, healthcare utilization, surveys, and exit data. Each captures participation in a system that requires disclosure.
...
This is not a flaw in Virginia's study design. It is a constraint of the available data. The data reflects participation in formal systems, not the full population affected. Findings may indicate manageable impact. They may be measuring manageable reported impact.

For leadership, this creates a predictable distortion: policy effectiveness will be evaluated on partial data.
