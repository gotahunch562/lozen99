...
excerpt: The corporate benefits landscape is currently dominated by what can
  ...
  as NFP’s specialized leave metrics published by HR Dive, routinely scolds the
  market for a lack of supply, characterizing the slow rollout of midlife health
  programs as a "missed opportunity" for employers.
description: >2+
   PwC says low menopause benefit utilization is an awareness problem. Lozen
  Advisory's research says it's a disclosure problem. For boards and GC, the
