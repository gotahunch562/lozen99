...
seo_title: "Massachusetts H5303: A Pathway With No Data Requirement"
slug: massachusetts-h5303-hrt-blind-spot
pubDate: 2026-06-29
datePublished: 2026-06-29
dateModified: 2026-06-29
category: Legislation & Policy
excerpt: "Massachusetts is moving Bill H.5303 to close a major coverage gap for
  perimenopause and menopause care, but a critical problem remains. While the
  legislation effectively removes insurance formulary loopholes for hormone
  replacement therapy (HRT), it leaves a 24-year-old blind spot completely
  intact: the state still requires absolutely no data collection or recurring
  audits to track whether these mandates are actually being honored in
  practice."
description: Massachusetts H5303 expands menopause care by closing the HRT
  formulary loophole, but leaves a 24-year blind spot intact. Discover why this
  coverage pathway remains invisible by design and leaves patient access
  unmeasured.
image:
  url: /src/images/blog/massachusetts-h5303-coverage-gap.avif
  alt: Conceptual illustration of a woman reviewing Massachusetts H5303
    legislation next to a foggy archway and blank charts, symbolizing the
    unmeasured data blind spot in HRT coverage
heroImage: /src/images/blog/massachusetts-h5303-coverage-gap-1.avif
heroAlt: Conceptual illustration of a woman reviewing Massachusetts H5303
  legislation next to a foggy archway and blank charts, symbolizing the
  unmeasured data blind spot in HRT coverage
tags:
  - Research & Policy
...
The headline version of this story is access: Massachusetts is closing a coverage gap. However, the pathway that closes it has existed since 2002. The open question isn't whether that pathway was real. It's [what data is required to validate whether the pathway activates or not.](/menopause-legislation-tracker/)
...
[H5303 closes the formulary loophole](https://malegislature.gov/Bills/194/H5303). It inserts new, absolute coverage sections into the same four chapters — Section 231 into Chapter 175, parallel sections into 176A, 176B, and 176G — each banning the utilization controls the 2002 law explicitly permitted. The old sections remain unrepealed, sitting beside the new ones in the same statutory family.
...
- [Virginia's Menopause Bill: A Split Outcome](/blog/virginia-menopause-bill-split-outcome/)
- [Maryland SB892: The Omnibus Approach to Menopause Care](/blog/maryland-sb892-menopause/)
- [New York S3908: The Workers'-Comp Policy Gap](/blog/ny-s3908-workers-comp-menopause-gap/)
